    ...
    <View className="flex-1 bg-black">
      ...
      <View className="relative h-44">
        <Image
          ...
          resizeMode="cover"
        />
        <View className="absolute top-4 right-4 flex-row space-x-3">
          <View className="justify-center items-center rounded-full mt-4 bg-ygradient-1 p-2 overflow-hidden mr-2">
              <Image source={icons.homeicon} tintColor="#00000" className="size-4"/>
          </View>
          <View className="justify-center items-center rounded-full mt-4 bg-ygradient-1 p-2 overflow-hidden">
              <Image source={icons.settingsicon} tintColor="#00000" className="size-4"/>
          </View>
        </View>
      </View>

      <View className="items-start -mt-12 ml-4 w-24 h-24 bg-gradient-to-r from-bgradient-1 to-bgradient-2">
        <Image
      ...
      <View className="flex-col items-start justify-center mx-6 mt-6 p-6 space-y-2 bg-ygradient-1 rounded-2xl">
      ...
      <View className="bg-ygradient-1 mx-6 mt-6 p-4 rounded-2xl">
        <Text className='text-dark text-lg'>Bio</Text>
        <Text className="text-light-200 text-base">{user.bio}</Text>
      </View>

      <View className="bg-ygradient-1 mx-6 mt-4 p-3 rounded-2xl">
        <Text className="text-black">Echo Member Since</Text>
        <Text className="text-light-200 text-base">{user.memberSince}</Text>
      </View>

      {/* <View className="absolute bottom-0 left-0 right-0 bg-gray-900 flex-row justify-around items-center h-16 rounded-t-2xl">
